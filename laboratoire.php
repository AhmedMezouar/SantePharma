          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info" style="float:right;">
                              <h2 class="wow fadeInUp" data-wow-delay="0.6s"  style="color:white;"><b>S</b>anté Pharma "Médecine"</h2>
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p style="color:white;">La médecine au sens de pratique, est la science témoignant de l'organisation du corps humain, 
                                        ...
                                        <p  style="color:white;">Besoin d’un médecin à proximité dans un n’importe quel domaine ?
